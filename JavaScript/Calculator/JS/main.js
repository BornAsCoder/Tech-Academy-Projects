//c reate an object to keep track of values
const Calculator = {
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //if we don't have decimal point already, we will add it
...
function Handle_Operator(Next_Operator) {
    ...
    // on the screen to a number and then store the result in Calculator.First Operand if
    ...
    if (First_Operand == null) {
        ...
        // if operator exists, property lookup is prefomed for the operator
        // in the Perform_Calculation object and the function that matches
